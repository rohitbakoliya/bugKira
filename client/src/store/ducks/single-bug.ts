...
export const TOGGLE_BUG = ApiActionCreator('singlebug/TOGGLE_BUG');
export const EDIT_LABELS = ApiActionCreator('singlebug/EDIT_LABELS');
export const UPDATE_BUG = ApiActionCreator('singlebug/UPDATE_BUG');
export const ADD_COMMENT = ApiActionCreator('singlebug/ADD_COMMENT');
export const EDIT_COMMENT = ApiActionCreator('singlebug/EDIT_COMMENT');
export const UPDATE_BUG_REACTIONS = ApiActionCreator('singlebug/UPDATE_BUG_REACTIONS');
export const UPDATE_COMMENT_REACTIONS = ApiActionCreator('singlebug/UPDATE_COMMENT_REACTIONS');
...
const reducer = (state = DEFAULT_STATE, action: IAction) => {
  switch (action.type) {
    ...
    case UPDATE_COMMENT_REACTIONS.FAILURE:
      ...
      let comment = toggleCommentReaction(state.entities.comments[action.payload.commentId], {
        emoji,
        userData,
      });
 ...
 */
const toggleCommentReaction = (inputComment: any, payload: { emoji: string; userData: any }) => {
  let comment = deepClone(inputComment);
  ...
  comment.reactions.forEach((react: any, index: number) => {
    let isEmojiPresent = comment.reactions.some((e: any) => e.emoji === payload.emoji);
    if (!isEmojiPresent) {
      comment.reactions.push({
        emoji: payload.emoji,
        users: [payload.userData],
    ...
    let indexOfUser = react.users.findIndex((u: any) => u.username === payload.userData.username);
...
export const addComment = (bugId: number | string, formData: { body: string }): ApiAction => ({
  type: API,
  payload: {
    method: 'PATCH',
...
export const updateBug = (bugId: number | string, formData: { body: string }): ApiAction => ({
  type: API,
  payload: {
    method: 'PATCH',
    url: `/api/bugs/${bugId}`,
...
export const openOrCloseBug = (bugId: number | string, state: string): ApiAction => ({
  type: API,
  payload: {
    method: 'PATCH',
...
export const editLabels = (bugId: number | string, labelData: string[]): ApiAction => ({
  type: API,
  payload: {
    method: 'PATCH',
...
export const addReferences = (bugId: number | string, references: string[]): ApiAction => ({
  type: API,
  payload: {
    method: 'PATCH',
...
export const mentionPeople = (bugId: number | string, mentions: string[]): ApiAction => ({
  type: API,
  payload: {
    method: 'POST',
...
export const addOrRemoveReacts = (bugId: number | string, emoji: string): ApiAction => ({
  type: API,
  payload: {
    method: 'PATCH',
