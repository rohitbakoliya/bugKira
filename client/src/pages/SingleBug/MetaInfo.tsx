...
const MetaInfo: React.FC<MetaProps> = ({ isOpen, date, author, commentsCount, showAvatar }) => (
  <StyledMetaInfo>
    <Flex gap="medium" align="center" nowrap>
      ...
      />
      {showAvatar && <Avatar width="30px" height="30px" size={45} username={author.username} />}
      <span>
